...
// stage content:
(lib.fortune_gold_love = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{},true);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(94).to({_off:false},0).to({regX:435.1/late,scaleX:1,scaleY:1,rotation:30,x:120.1/late,y:-102.4/late,alpha:0.121},48,cjs.Ease.get(1)).to({_off:true},1).wait(19));
	...
	this.instance_32.setTransform(541.8/late,565.2/late,0.906,0.905,0,0,0,39.5/late,47/late);

	this.instance_33 = new lib.tourou();
	this.instance_33.setTransform(114.7/late,566.2/late,0.906,0.905,0,0,0,39.5/late,47/late);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_33},{t:this.instance_32}]},19).to({state:[]},124).to({state:[]},1).wait(41));

	// 燭台
	this.instance_34 = new lib.tourou();
	this.instance_34.setTransform(554.9/late,620.4/late,0.931,0.93,0,0,0,39.5/late,47/late);

	this.instance_35 = new lib.tourou();
	this.instance_35.setTransform(101.8/late,620.4/late,0.931,0.93,0,0,0,39.5/late,47/late);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_35},{t:this.instance_34}]},19).to({state:[]},124).to({state:[]},1).wait(41));

	// 燭台
	this.instance_36 = new lib.tourou();
	this.instance_36.setTransform(572.9/late,696.5/late,0.957,0.957,0,0,0,39.5/late,47/late);

	this.instance_37 = new lib.tourou();
	this.instance_37.setTransform(86.8/late,696.5/late,0.957,0.957,0,0,0,39.5/late,47/late);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_37},{t:this.instance_36}]},19).to({state:[]},124).to({state:[]},1).wait(41));

	// 燭台
	this.instance_38 = new lib.tourou();
	this.instance_38.setTransform(591.6/late,781.6/late,1,1,0,0,0,39.5/late,47/late);

	this.instance_39 = new lib.tourou();
	this.instance_39.setTransform(67.5/late,781.6/late,1,1,0,0,0,39.5/late,47/late);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_39},{t:this.instance_38}]},19).to({state:[]},124).to({state:[]},1).wait(41));

	// 黒い板
	this.instance_40 = new lib.kuroita();
	this.instance_40.setTransform(326.1/late,414.1/late,1,1,0,0,0,346.1/late,434.1/late);
	this.instance_40.alpha = 0;
	this.instance_40._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_40).wait(7).to({_off:false},0).to({alpha:0.5},9,cjs.Ease.get(1)).to({_off:true},127).wait(41));

	// 扉
	this.instance_41 = new lib.tobira();
	this.instance_41.setTransform(480/late,423.6/late,1,1,0,0,180,0,270/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_41).wait(20).to({scaleX:1},24,cjs.Ease.get(-0.99)).to({scaleX:0.67},88).to({_off:true},4).wait(19));

	// 扉
	this.instance_42 = new lib.tobira();
	this.instance_42.setTransform(179.1/late,423.6/late,1,1,0,0,0,0,270/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_42).wait(20).to({scaleX:1},24,cjs.Ease.get(-0.99)).to({scaleX:0.64},88).to({_off:true},4).wait(19));

	// BG
	this.instance_43 = new lib.BG("synched",0);
	this.instance_43.setTransform(325.5/late,417/late,1,1,0,0,0,325.5/late,417/late);

	this.instance_44 = new lib.hoshizora2();

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_43}]}).to({state:[]},136).to({state:[{t:this.instance_44}]},14).wait(35));
...
(lib.akari = function() {
	...
	this.shape_4.graphics.beginLinearGradientFill(["rgba(255,191,191,0.302)","rgba(255,203,203,0)"],[0,1],0,400.1/late,0,-399.9/late).beginStroke().moveTo(346.1/late,-434.1/late).lineTo(346.1/late,434.1/late).lineTo(-346.1/late,434.1/late).lineTo(-346.1/late,-434.1/late).closePath();
...
(lib.オーロラ = function(mode,startPosition,loop) {
	...
	//this.timeline.addTween(cjs.Tween.get(this.instance_9).to({scaleY:0.55,alpha:1},59,cjs.Ease.get(1)).to({regY:854.5/late,scaleY:0.99,y:854.5,alpha:0.25},59,cjs.Ease.get(-0.99)).wait(1));
...
(lib.tourou = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({regX:39.5/late,scaleX:0.55,scaleY:0.55,x:39.5/late,alpha:0.379},5,cjs.Ease.get(-0.99)).to({scaleX:1.07,scaleY:1.07,alpha:1},2).to({scaleX:1,scaleY:1},2).wait(66));
...
(lib.kirakirahikaru2 = function(mode,startPosition,loop) {
	...
	this.instance_11.setTransform(66.2/late,65.8/late,1,1,0,0,0,66.2/late,65.8/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(2).to({alpha:0.699},0).wait(2).to({alpha:1},0).wait(2).to({alpha:0.699},0).wait(2));
...
(lib.kirakirahikaru = function(mode,startPosition,loop) {
	...
	// レイヤー 1
	this.instance_12 = new lib.kirakirahikaru2();
	this.instance_12.setTransform(120.5/late,135.9/late,1,1,0,0,0,120.5/late,119.9/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(39).to({y:119.9/late},0).to({y:66/late},4).to({y:-782.4/late},121).to({y:-891.1/late,alpha:0},20).wait(1));
...
(lib.hikari_1 = function(mode,startPosition,loop) {
	...
	// レイヤー 2
	this.instance_13 = new lib.sirohikari();
	this.instance_13.setTransform(-58/late,-154.4/late,1,1,0,0,0,45/late,263/late);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(29).to({_off:false},0).to({alpha:1},30,cjs.Ease.get(1)).to({alpha:0},30).wait(1));

	// レイヤー 1
	this.instance_14 = new lib.kiirohikari();
	this.instance_14.setTransform(-58/late,-154.4/late,1,1,0,0,0,45/late,263/late);
	this.instance_14.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({alpha:1},29,cjs.Ease.get(1)).to({alpha:0},30,cjs.Ease.get(-0.99)).to({alpha:1},30).wait(1));
...
(lib.card2_1 = function(mode,startPosition,loop) {
	...
	// レイヤー 1
	this.instance_15 = new lib.card2();
	this.instance_15.setTransform(1.3,1.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_15}]}).wait(120));

	// レイヤー 2
	this.instance_16 = new lib.cardback_1();
	this.instance_16.setTransform(294.5/late,450/late,1,1,0,0,0,351.5/late,500/late);
	this.instance_16.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).to({alpha:1},60).to({alpha:0},59).wait(1));
...
(lib.card = function(mode,startPosition,loop) {
	...
	// レイヤー 1
	this.instance_17 = new lib.card2_1();
	this.instance_17.setTransform(292.5/late,447/late,1,1,0,0,0,292.5/late,447/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(14).to({y:426.8/late},45).to({y:446.6/late},44).wait(1));
...
(lib.hikarinaka = function(mode,startPosition,loop) {
	...
	this.instance_18.setTransform(0,0,1,0.232,-89.9,0,0,45/late,526/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_18).to({scaleY:1},29,cjs.Ease.get(1)).wait(31));

	// hikari
	this.instance_19 = new lib.hikari_1();
	this.instance_19.setTransform(0,0,1,0.239,180,0,0,45/late,526/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_19).to({scaleY:1},29,cjs.Ease.get(1)).wait(31));

	// hikari
	this.instance_20 = new lib.hikari_1();
	this.instance_20.setTransform(0,0,1,0.243,90,0,0,45/late,526/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_20).to({scaleY:1},29,cjs.Ease.get(1)).wait(31));

	// hikari
	this.instance_21 = new lib.hikari_1();
	this.instance_21.setTransform(0,0,1,0.255,0,0,0,45/late,526/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_21).to({scaleY:1},29,cjs.Ease.get(1)).wait(31));
