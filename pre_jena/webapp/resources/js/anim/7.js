...
// stage content:
(lib.fortune_gold_gorgeous_love = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{},true);
	...
	this.instance_1.setTransform(37/late,994/late,0.946,0.946,0,0,0,37.1/late,53/late);
	...
	// ハート
	this.instance_22 = new lib.heart2();
	this.instance_22.setTransform(332.8/late,313.5/late,1.187,1.187,0,0,0,435/late,380/late);
	this.instance_22.alpha = 0.121;
	this.instance_22._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(105).to({_off:false},0).to({scaleX:12.33,scaleY:12.33,x:332.9/late,alpha:0.398},37,cjs.Ease.get(1)).to({_off:true},1).wait(19));

	// ハート
	this.instance_23 = new lib.heart_1();
	this.instance_23.setTransform(357.9/late,288.4/late,0.351,0.351,90,0,0,435/late,380/late);
	this.instance_23._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(94).to({_off:false},0).to({regX:434.9/late,scaleX:0.61,scaleY:0.61,rotation:144.9,x:242.1/late,y:145.4/late,alpha:0.641},11,cjs.Ease.get(1)).to({regX:435/late,scaleX:1,scaleY:1,rotation:225.1,x:525.6/late,y:751.7/late,alpha:0.121},37).to({_off:true},1).wait(19));

	// ハート
	this.instance_24 = new lib.heart_1();
	this.instance_24.setTransform(298.9/late,310.1/late,0.339,0.339,180,0,0,435.1/late,380.1/late);
	this.instance_24._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(94).to({_off:false},0).to({regX:435/late,regY:380/late,scaleX:1,scaleY:1,rotation:135,x:761.2/late,y:126.1/late,alpha:0.121},48,cjs.Ease.get(1)).to({_off:true},1).wait(19));

	// ハート
	this.instance_25 = new lib.heart_1();
	this.instance_25.setTransform(307.5/late,348.7/late,0.319,0.319,-89.9,0,0,434.9/late,380/late);
	this.instance_25._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(94).to({_off:false},0).to({regX:435.1/late,scaleX:1,scaleY:1,rotation:30/late,x:120.1/late,y:-102.4/late,alpha:0.121},48,cjs.Ease.get(1)).to({_off:true},1).wait(19));

	// ハート
	this.instance_26 = new lib.heart_1();
	this.instance_26.setTransform(366.1/late,328.3/late,0.347,0.347,180,0,0,435/late,379.9/late);
	this.instance_26._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(94).to({_off:false},0).to({regY:380/late,scaleX:1,scaleY:1,rotation:315.1,x:-93.7/late,y:506.2/late,alpha:0.121},48,cjs.Ease.get(1)).to({_off:true},1).wait(19));

	// 光
	this.instance_27 = new lib.hikarinaka();
	this.instance_27.setTransform(329.6/late,305.9/late,1,1,113.2);
	this.instance_27._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(111).to({_off:false},0).to({_off:true},32).wait(41));

	// 光
	this.instance_28 = new lib.hikarinaka();
	this.instance_28.setTransform(326.3/late,305.9/late,1,1,83.2);
	this.instance_28._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_28).wait(109).to({_off:false},0).to({_off:true},34).wait(41));

	// 光
	this.instance_29 = new lib.hikarinaka();
	this.instance_29.setTransform(325.1/late,305.9/late,1,1,45);
	this.instance_29._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_29).wait(89).to({_off:false},0).to({_off:true},54).wait(41));

	// 光
	this.instance_30 = new lib.hikarinaka();
	this.instance_30.setTransform(328.6/late,305.9/late);
	this.instance_30._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_30).wait(45).to({_off:false},0).to({_off:true},98).wait(41));

	// レイヤー 13
	this.instance_31 = new lib.akari();
	this.instance_31.setTransform(326.1/late,414.1/late,1,1,0,0,0,346.1/late,434.1/late);
	this.instance_31.alpha = 0;
	this.instance_31._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_31).wait(19).to({_off:false},0).to({alpha:0.648},19,cjs.Ease.get(1)).to({_off:true},105).wait(41));

	// 燭台
	this.instance_32 = new lib.kirakirahikaru2copy();
	this.instance_32.setTransform(548.8/late,587/late,0.633,0.633,0,0,180,37.4/late,88.2/late);

	this.instance_33 = new lib.kirakirahikaru2copy();
	this.instance_33.setTransform(114.7/late,587/late,0.633,0.633,0,0,0,37.4/late,88.2/late);

	this.instance_34 = new lib.tourou();
	this.instance_34.setTransform(541.8/late,565.2/late,0.906,0.905,0,0,0,39.5/late,47/late);

	this.instance_35 = new lib.tourou();
	this.instance_35.setTransform(114.7/late,566.2/late,0.906,0.905,0,0,0,39.5/late,47/late);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_35},{t:this.instance_34},{t:this.instance_33},{t:this.instance_32}]},25).to({state:[]},118).to({state:[]},1).wait(41));

	// 燭台
	this.instance_36 = new lib.kirakirahikaru2copy();
	this.instance_36.setTransform(560.8/late,652.8/late,0.804,0.804,0,0,180,37.4/late,88.2/late);

	this.instance_37 = new lib.kirakirahikaru2copy();
	this.instance_37.setTransform(102.7/late,652.8/late,0.804,0.804,0,0,0,37.4/late,88.2/late);

	this.instance_38 = new lib.tourou();
	this.instance_38.setTransform(554.9/late,620.4/late,0.931,0.93,0,0,0,39.5/late,47/late);

	this.instance_39 = new lib.tourou();
	this.instance_39.setTransform(101.8/late,620.4/late,0.931,0.93,0,0,0,39.5/late,47/late);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_39},{t:this.instance_38},{t:this.instance_37},{t:this.instance_36}]},22).to({state:[]},121).to({state:[]},1).wait(41));

	// 燭台
	this.instance_40 = new lib.kirakirahikaru2copy();
	this.instance_40.setTransform(577.5/late,731.8/late,0.931,0.931,0,0,180,37.4/late,88.2/late);

	this.instance_41 = new lib.kirakirahikaru2copy();
	this.instance_41.setTransform(86/late,731.8/late,0.931,0.931,0,0,0,37.4/late,88.2/late);

	this.instance_42 = new lib.tourou();
	this.instance_42.setTransform(572.9/late,696.5/late,0.957,0.957,0,0,0,39.5/late,47/late);

	this.instance_43 = new lib.tourou();
	this.instance_43.setTransform(86.8/late,696.5/late,0.957,0.957,0,0,0,39.5/late,47/late);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_43},{t:this.instance_42},{t:this.instance_41},{t:this.instance_40}]},19).to({state:[]},124).to({state:[]},1).wait(41));

	// 燭台
	this.instance_44 = new lib.kirakirahikaru2copy();
	this.instance_44.setTransform(512.1/late,855.3/late,1,1,0,0,180,120.5/late,119.9/late);

	this.instance_45 = new lib.kirakirahikaru2copy();
	this.instance_45.setTransform(151.4/late,855.3/late,1,1,0,0,0,120.5/late,119.9/late);

	this.instance_46 = new lib.tourou();
	this.instance_46.setTransform(591.6/late,781.6/late,1,1,0,0,0,39.5/late,47/late);

	this.instance_47 = new lib.tourou();
	this.instance_47.setTransform(67.5/late,781.6/late,1,1,0,0,0,39.5/late,47/late);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_47},{t:this.instance_46},{t:this.instance_45},{t:this.instance_44}]},16).to({state:[]},127).to({state:[]},1).wait(41));

	// 黒い板
	this.instance_48 = new lib.kuroita();
	this.instance_48.setTransform(326.1/late,414.1/late,1,1,0,0,0,346.1/late,434.1/late);
	this.instance_48.alpha = 0;
	this.instance_48._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_48).wait(7).to({_off:false},0).to({alpha:0.5},9,cjs.Ease.get(1)).to({_off:true},127).wait(41));

	// 扉
	this.instance_49 = new lib.tobira();
	this.instance_49.setTransform(480/late,423.6/late,1,1,0,0,180,0,270/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_49).wait(20).to({scaleX:1},24,cjs.Ease.get(-0.99)).to({scaleX:0.67},88).to({_off:true},4).wait(19));

	// 扉
	this.instance_50 = new lib.tobira();
	this.instance_50.setTransform(179.1/late,423.6/late,1,1,0,0,0,0,270/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_50).wait(20).to({scaleX:1},24,cjs.Ease.get(-0.99)).to({scaleX:0.64},88).to({_off:true},4).wait(19));

	// BG
	this.instance_51 = new lib.BG("synched",0);
	this.instance_51.setTransform(325.5/late,417/late,1,1,0,0,0,325.5/late,417/late);

	this.instance_52 = new lib.hoshizora2();

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_51}]}).to({state:[]},136).to({state:[{t:this.instance_52}]},14).wait(35));
...
(lib.heart2 = function() {
	...
	this.instance_5.setTransform(382.5/late,334.1/late,0.121,0.121);

	this.addChild(this.instance_5);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(382.5/late,334.1/late,105.1,91.8);
...
(lib.heart_1 = function(mode,startPosition,loop) {
	...
	this.instance_6.setTransform(382.5/late,334.1/late,0.121/late,0.121/late);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6,p:{scaleX:0.121,x:382.5/late}}]}).to({state:[{t:this.instance_6,p:{scaleX:0.064,x:407.3/late}}]},2).to({state:[{t:this.instance_6,p:{scaleX:0.018,x:427.3/late}}]},2).to({state:[{t:this.instance_6,p:{scaleX:0.064,x:407.3/late}}]},2).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(382.5/late,334.1/late,105.1/late,91.8/late);
...
(lib.cardback_1 = function() {
	...
	// レイヤー 1
	this.instance_7 = new lib.cardback3();
	this.instance_7.setTransform(-3.9/late,0);
...
(lib.akari = function() {
	...
	this.shape_4.graphics.beginLinearGradientFill(["rgba(255,191,191,0.302)","rgba(255,203,203,0)"],[0,1],0,400.1,0,-399.9).beginStroke().moveTo(346.1/late,-434.1/late).lineTo(346.1/late,434.1/late).lineTo(-346.1/late,434.1/late).lineTo(-346.1/late,-434.1/late).closePath();
...
(lib.オーロラ = function(mode,startPosition,loop) {
	...
	// レイヤー 1
	this.instance_9 = new lib.オーロラ２();
	this.instance_9.setTransform(332.8/late,854.4/late,1,1,0,0,0,332.8/late,854.4/late);
	this.instance_9.alpha = 0.25;

	//this.timeline.addTween(cjs.Tween.get(this.instance_9).to({scaleY:0.55,alpha:1},59,cjs.Ease.get(1)).to({regY:854.5/late,scaleY:0.99,y:854.5/late,alpha:0.25},59,cjs.Ease.get(-0.99)).wait(1));
...
(lib.tourou = function(mode,startPosition,loop) {
	...
	// レイヤー 1
	this.instance_10 = new lib.tourou2();
	this.instance_10.setTransform(39.6/late,47/late,0.489,0.489,0,0,0,39.6/late,47/late);
	this.instance_10.alpha = 0.301;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({regX:39.5/late,scaleX:0.55,scaleY:0.55,x:39.5/late,alpha:0.379},5,cjs.Ease.get(-0.99)).to({scaleX:1.07,scaleY:1.07,alpha:1},2).to({scaleX:1,scaleY:1},2).wait(101));
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{},true);
	...
	this.instance_11.setTransform(43.3/late,70.2/late,0.147,0.147,180,0,0,36.9/late,37.1/late);

	this.instance_12 = new lib.kirakirahikaru3();
	this.instance_12.setTransform(27.2/late,86/late,0.213,0.213,180,0,0,37.2/late,37/late);

	this.instance_13 = new lib.kirakirahikaru3();
	this.instance_13.setTransform(45.2/late,101.2/late,0.282,0.282,180,0,0,37.1/late,37.1/late);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13,p:{regX:37.1/late,scaleX:0.282,scaleY:0.282,x:45.2/late,y:101.2/late}},{t:this.instance_12,p:{regX:37.2/late,regY:37/late,scaleX:0.213,scaleY:0.213,x:27.2/late,y:86/late}},{t:this.instance_11,p:{regX:36.9/late,scaleX:0.147,scaleY:0.147,x:43.3/late,y:70.2/late,regY:37.1/late}}]}).to({state:[{t:this.instance_13,p:{regX:37.2/late,scaleX:0.348,scaleY:0.348,x:27.2/late,y:86/late}},{t:this.instance_12,p:{regX:36.9/late,regY:37.1/late,scaleX:0.241,scaleY:0.241,x:43.3/late,y:70.2/late}},{t:this.instance_11,p:{regX:36.8/late,scaleX:0.16,scaleY:0.16,x:37.3/late,y:51.3/late,regY:37.1/late}}]},2).to({state:[{t:this.instance_12,p:{regX:36.9/late,regY:37.1/late,scaleX:0.323,scaleY:0.323,x:43.3/late,y:70.2/late}},{t:this.instance_11,p:{regX:36.8/late,scaleX:0.255,scaleY:0.255,x:37.3/late,y:51.3/late,regY:37.2/late}}]},2).to({state:[{t:this.instance_11,p:{regX:36.8/late,scaleX:0.405,scaleY:0.405/late,x:37.3/late,y:51.4/late,regY:37.1/late}}]},2).to({state:[]},2).wait(102));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(19.2/late,64.8/late,36.5/late,46.8/late);
...
(lib.kirakirahikaru2 = function(mode,startPosition,loop) {
	...
	this.instance_14.setTransform(66.2/late,65.8/late,1,1,0,0,0,66.2/late,65.8/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(2).to({alpha:0.699},0).wait(2).to({alpha:1},0).wait(2).to({alpha:0.699},0).wait(2));

	// レイヤー 2
	this.instance_15 = new lib.kirakirahikaru3();
	this.instance_15.setTransform(34.3/late,89.8/late,0.403,0.403,0,0,0,37.2/late,37/late);

	this.instance_16 = new lib.kirakirahikaru3();
	this.instance_16.setTransform(45.3/late,66.8/late,0.255,0.255,0,0,0,37.2/late,37/late);

	this.instance_17 = new lib.kirakirahikaru3();
	this.instance_17.setTransform(26.7/late,66.8/late,0.201,0.201,0,0,0,37.1/late,37.1/late);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_16,p:{scaleX:0.255,scaleY:0.255,x:45.3/late,y:66.8/late,rotation:0}},{t:this.instance_15,p:{regX:37.2/late,regY:37/late,scaleX:0.403,scaleY:0.403,x:34.3/late,y:89.8/late,rotation:0}}]}).to({state:[{t:this.instance_17,p:{rotation:0,x:26.7/late,y:66.8/late}},{t:this.instance_16,p:{scaleX:0.213,scaleY:0.213,x:44.8/late,y:81.9/late,rotation:0}},{t:this.instance_15,p:{regX:36.9/late,regY:37.1/late,scaleX:0.187,scaleY:0.187,x:34.2/late,y:101.8/late,rotation:0}}]},2).to({state:[{t:this.instance_16,p:{scaleX:0.255,scaleY:0.255,x:28.8/late,y:95.2/late,rotation:180}},{t:this.instance_15,p:{regX:37.2/late,regY:37,scaleX:0.403,scaleY:0.403,x:39.8/late,y:72.2/late,rotation:180}}]},2).to({state:[{t:this.instance_17,p:{rotation:180,x:45.2/late,y:101.2/late}},{t:this.instance_16,p:{scaleX:0.213,scaleY:0.213,x:27.2/late,y:86/late,rotation:180}},{t:this.instance_15,p:{regX:36.9/late,regY:37.1/late,scaleX:0.187,scaleY:0.187,x:37.8/late,y:66.2/late,rotation:180}}]},2).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,74.4/late,104.7/late);
...
(lib.kirakirahikaru = function(mode,startPosition,loop) {
	...
	// レイヤー 1
	this.instance_18 = new lib.kirakirahikaru2();
	this.instance_18.setTransform(120.5/late,135.9/late,1,1,0,0,0,120.5/late,119.9/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(39).to({y:119.9/late},0).to({y:66/late},4).to({y:-782.4/late},121).to({y:-891.1/late,alpha:0},20).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,16/late,74.4/late,104.7/late);
...
(lib.hikari_1 = function(mode,startPosition,loop) {
	...
	// レイヤー 2
	this.instance_19 = new lib.sirohikari();
	this.instance_19.setTransform(-58/late,-154.4/late,1,1,0,0,0,45/late,263/late);
	this.instance_19.alpha = 0;
	this.instance_19._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(29).to({_off:false},0).to({alpha:1},30,cjs.Ease.get(1)).to({alpha:0},30).wait(1));

	// レイヤー 1
	this.instance_20 = new lib.kiirohikari();
	this.instance_20.setTransform(-58/late,-154.4/late,1,1,0,0,0,45/late,263/late);
	this.instance_20.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).to({alpha:1},29,cjs.Ease.get(1)).to({alpha:0},30,cjs.Ease.get(-0.99)).to({alpha:1},30).wait(1));
...
(lib.card2 = function(mode,startPosition,loop) {
	...
	// レイヤー 1
	this.instance_21 = new lib.cardrare();

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_21}]}).wait(120));

	// レイヤー 2
	this.instance_22 = new lib.cardback_1();
	this.instance_22.setTransform(294.5/late,450/late,1,1,0,0,0,351.5/late,500/late);
	this.instance_22.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_22).to({alpha:1},60).to({alpha:0},59).wait(1));
...
(lib.card = function(mode,startPosition,loop) {
	...
	// レイヤー 1
	this.instance_23 = new lib.card2();
	this.instance_23.setTransform(292.5/late,447/late,1,1,0,0,0,292.5/late,447/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(14).to({y:426.8/late},45).to({y:446.6/late},44).wait(1));
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{},true);
	...
	this.instance_24.setTransform(0,0,1,0.232,-89.9,0,0,45/late,526/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_24).to({scaleY:1},29,cjs.Ease.get(1)).wait(41));

	// hikari
	this.instance_25 = new lib.hikari_1();
	this.instance_25.setTransform(0,0,1,0.239,180,0,0,45/late,526/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_25).to({scaleY:1},29,cjs.Ease.get(1)).wait(41));

	// hikari
	this.instance_26 = new lib.hikari_1();
	this.instance_26.setTransform(0,0,1,0.243,90,0,0,45/late,526/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_26).to({scaleY:1},29,cjs.Ease.get(1)).wait(41));

	// hikari
	this.instance_27 = new lib.hikari_1();
	this.instance_27.setTransform(0,0,1,0.255,0,0,0,45/late,526/late);

	this.timeline.addTween(cjs.Tween.get(this.instance_27).to({scaleY:1},29,cjs.Ease.get(1)).wait(41));
